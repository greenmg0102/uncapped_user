...
export default function PreflopChart({ reportingResult, reportItemActive, setReportItemActive }: any) {
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center flex-wrap">
            {
                Object.keys(reportingResult).length > 0 ?
                    ...
                    <div className='h-[250px] sm:h-[450px] flex flex-col justify-center items-center w-full'>
                        ...
                        <p className='text-[20px] mt-4'>There is no standard data prepared for this!</p>
