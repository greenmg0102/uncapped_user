...
export default function Invoice({ isOpen, data, setIsOpen }: any) {
                                ...
                                <div className="p-5">
                                    {
                                        ...
                                        Object.keys(data.invoice).map((key: any, index: any) =>
                                            <div
                                                key={index}
                                    ...
                                    <div className="flex justify-end items-center mt-8">
                                        <button type="button" className="btn btn-primary ltr:ml-4 rtl:mr-4" onClick={() => setIsOpen(false)}>
                                            Cancel
                                        </button>
                                    </div>
                                </div>
