...
export default function VillianPokerTable({ villianPokerTable, actionLit, SqueezeStackDepth }: any) {
    ...
    return (
        <div className="flex justify-center items-center h-[155px] w-full max-w-[500px]">
            <div className="relative w-[calc(100%-50px)] flex justify-center items-center flex-col border border-[2px] border-gray-600 rounded-full h-[130px]">
                {/* <p className="fond-bold text-[20px] mb-2">Uncapped</p> */}

                <div className='flex justify-between md:justify-start items-start flex-wrap mt-2'>
                ...
                <p className={clsx((SqueezeStackDepth === 0 || SqueezeStackDepth === undefined) ? "hidden" : "fond-bold text-[14px] text-gray-200 mt-2")}>{SqueezeStackDepth === 398750 ? 40 : SqueezeStackDepth} bb</p>
