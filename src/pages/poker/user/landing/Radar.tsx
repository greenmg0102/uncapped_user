        ...
        <div>
            ...
            >
                ...
                <div className="flex-1">
                    ...
                    <p className="text-center ltr:sm:text-left rtl:sm:text-right">New Brand Poker Strategy Analyzing platform with Histogram</p>
                    <div className="mt-1 sm:mt-1 w-full pr-0 md:pr-24">
                        ...
                        >
                            <div className="absolute inset-0 flex items-center justify-center">
                                <img src="/assets/images/loading.png" alt="radar" className="ml-80 w-1/2 opacity-10 hidden lg:block transition-all" />
                            </div>
                            ...
                            <div className='absolute right-0 w-[100%] lg:w-[70%] transition-all'>
                                <img src="/assets/images/pokerImage/1_2.png" alt="radar" className="opacity-[45%]" />
                            </div>
                        </div>
                    </div>
                </div>
