...
const StasticData = () => {
    ...
    const [deviations, setDeviations] = useState<any>(undefined)
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            let { result, total } = await globalStatistic(data)
            ...
            real.push({
                ...
                xXios: [...Array(total).fill(0).map((item: any, index: any) => index)]
            })
