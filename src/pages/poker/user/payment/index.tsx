    ...
    return (
        <Tab.Group>
            ...
            <div className="active p-4 pt-5 border border-gray-900 rounded-[8px] flex justify-between items-start flex-wrap">
                ...
                {
                    payway === 'Free' ?
                        <div className='w-full xl:w-3/5 pl-2 h-[450px] mt-4 xl:mt-0 transition-all flex justify-center items-center flex-col'>
                            <div className='flex justify-center items-center mb-12 shadow-2xl'>
                                <svg width="100px" height="100px" viewBox="0 0 61.7998 61.7998" xmlns="http://www.w3.org/2000/svg">
                                    <g data-name="Layer 2" id="Layer_2">
                                        <g>
                                            ...
                                            <path d="M19.113 25.706c-2.83-4.958-2.783-9.375-1.362-11.817 2.048-3.52 4.922-3.688 5.315-4.517 4.025-8.479 24.839-2.048 23.97 11.09a14.798 14.798 0 0 0-1.522-2.486s-.075 4.991-1.437 6.957c-1.64.464-15.061.239-20.053-9.948-4.006 2.268-5.06 7.015-4.91 10.72z" fill="#969696" fillRule="evenodd" />
                                            <path d="M31.15 46.543c-2.66.022-15.617-4.022-12.61-26.045 0 0 .65 9.916 2.775 12.788 1.382 1.868 2.625 2.57 3.82.746 1.248-1.9 3.946-3.473 6.038-1.677 1.737-1.85 4.848-.212 6.084 1.677 1.195 1.823 2.44 1.123 3.822-.746 2.125-2.872 2.586-12.456 2.586-12.456 3.456 23.6-9.855 25.735-12.515 25.713z" fill="#969696" fillRule="evenodd" />
                                            <path d="M26.527 36.802a7.118 7.118 0 0 1 4.568-2.096 7.29 7.29 0 0 1 4.503 2.099c-.788.525-5.874 1.737-9.071-.003z" fill="#ffe8be" fillRule="evenodd" />
                                            <path d="M26.611 51.297a29.35 29.35 0 0 0-8.171-3.501c-4.778-.758-13.423-1.518-11.271-10.086C12.023 18.38 18.85 3.688 31.457 3.87c12.836.184 19.09 15.8 23.84 33.865 1.904 7.238-6.79 9.313-11.508 10.06A21.129 21.129 0 0 0 36 51.14c-6.963 4.765-1.812 4.7-9.389.158zm4.851 1.198a14.292 14.292 0 0 1 10.663-6.6c5.422-.86 14.562-4.28 8.565-9.72-10.765-9.764-6.167-22.032-19.638-22.032-12.615 0-8.748 12.268-19.513 22.032-5.997 5.44 3.143 8.86 8.564 9.72 1.97.313 8.017 1.127 11.36 6.6z" fill="#7d7062" fillRule="evenodd" />
                                            <path d="M24.202 50.213s5.988 3.256 7.588 7.992c1.61-5.121 7.627-8.327 7.627-8.327S33.07 52.33 31.7 55.534c-.973-1.722-2.707-3.4-7.497-5.321z" fill="#302e33" fillRule="evenodd" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            <p className='text-center px-2 lg:px-12 text-[24px] text-gray-400 leading-9'>
                                You can analyze your poker hand and found the great strategy for great winning, but the accuracy will be very low
                            </p>
                        </div> :
