...
export default function FilteringOption({ isFilterModal, filteringCheckOption, setIsFilterModal, setFilteringCheckOption }: any) {
    ...
    return (
        <div
            className={clsx(
                "absolute h-[400px] border transition-all duration-[0.3s] right-0 overflow-hidden bg-gray-800 !z-[222222] rounded-tl-[8px] rounded-bl-[8px] border-gray-500 opacity-[93%]",
                isFilterModal ? "w-full p-4" : "w-[0px] p-0 border-[0px]"
            )}
        >
