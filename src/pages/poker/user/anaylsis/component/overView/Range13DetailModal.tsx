...
const Range13DetailModal = ({ handResult }: any) => {
                ...
                <div>
                    <div className="flex justify-between items-center">
                        ...
                        <p className="w-1/3 text-[#7d1f1f] font-bold text-center">
                            {/* {(handResult.evs[2] === undefined ? 0 : handResult.evs[2]).toFixed(1)} */}
                        </p>
                        <p className="w-1/3 text-[#7d1f1f] font-bold text-right">
                            {/* {(handResult.played[2] === undefined ? 0 : handResult.played[2] * 100).toFixed(1)} % */}
                        </p>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <p className="w-1/3 text-[#00cf00] font-bold text-center">
                            {/* {(handResult.evs[3] === undefined ? 0 : handResult.evs[3]).toFixed(1)} */}
                        </p>
                        <p className="w-1/3 text-[#00cf00] font-bold text-right">
                            {/* {(handResult.played[3] === undefined ? 0 : handResult.played[3] * 100).toFixed(1)} % */}
                        </p>
                    </div>
                    <div className="flex justify-between items-center">
...
export default Range13DetailModal;
