...
export default function PremiumDescription({ price, tabOrder, isMonthly, pay }: any) {
    ...
    return (
        <div className="relative p-4">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className=" text-center flex justify-center items-center space-x-4 rtl:space-x-reverse font-semibold text-base">
                    ...
                    <label className="w-12 h-6 relative">
                        <input
                            ...
                            onChange={() => pay(isMonthly ? 19 : 189, !isMonthly, tabOrder)}
                        />
                ...
                <img src="/assets/images/pokerImage/premiumBadge256.png" alt="img" className="w-32 h-32 rounded-full" />
            </div>
            ...
            <div className="flex justify-center mt-0">
                <div>
                    <div className="flex justify-start items-center mb-4">
                        ...
                        <p className="text-[16px] text-gray-400 ml-4">Premium Reporting</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">Expanded Reporting</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">Multiway Addon</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">Blinds Battle Addon</p>
                    </div>
                    <div className="flex justify-start items-center mb-4">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="check" width="1em" height="1em" fill="currentColor" aria-hidden="true" className="text-green-700"><path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z"></path></svg>
                        <p className="text-[16px] text-gray-400 ml-4">Premium Chart Set</p>
                    </div>
                    <div className="mb-4 pl-8">
                        <p className="text-[16px] text-gray-400 mb-2">Hish Accuracy Simulations with limps and cold call options:</p>
                    ...
                    <div className="mb-4 pl-8">
                        <p className="text-[16px] text-gray-400 mb-2">Early Access to new charts and features!</p>
                    </div>
                    <div className="flex justify-start items-center mb-4">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="check" width="1em" height="1em" fill="currentColor" aria-hidden="true" className="text-green-700"><path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z"></path></svg>
                        <p className="text-[16px] text-gray-400 ml-4">Expanded Database Access</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">50, 000 uploads / month</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">Full Historical data tracking</p>
                    </div>
                    <div className="flex justify-start items-center mb-4 pl-8">
                        <div className="w-[5px] h-[5px] bg-blue-400 rounded-full" />
                        <p className="text-[16px] text-gray-400 ml-4">Complete Database Filtering</p>
                    </div>
                </div>
            </div>
        </div>
