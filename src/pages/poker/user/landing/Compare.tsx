...
export default function Compare() {
    ...
    return (
        <div>
            <div id="compare" className="sm:flex transition-all">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-1 sm:mt-1 w-full lg:pr-24 pb-12 pt-12">
                        <div className='flex justify-center justify-between items-center flex-wrap w-full'>
                            <div className='w-full 2xl:w-1/2 pl-0 2xl:pl-24 pl-0 md:pl-4 pb-24'>
