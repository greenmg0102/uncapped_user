export default function ColorChart({ type }: any) {
        ...
        <div>
            {
                type === 'fold' &&
                <div
                    className="w-[15px] h-[39.5em] bg-gradient-to-b from-opacity-1 to-opacity-0 bg-[#3d7cb8]"
            ...
            }
            {
                type === 'call' &&
                <div
                    className="w-[15px] h-[39.5em] bg-gradient-to-b from-opacity-1 to-opacity-0 bg-[#00cf00]"
            ...
            }
            {
                type === 'raise' &&
                <div
                    className="w-[15px] h-[39.5em] bg-gradient-to-b from-opacity-1 to-opacity-0 bg-[#ff0000]"
            ...
            }
            {
                type === 'allin' &&
                <div
                    className="w-[15px] h-[39.5em] bg-gradient-to-b from-opacity-1 to-opacity-0 bg-[#7d1f1f]"
            ...
            }
            {
                type === 'sum' &&
                <div
                    className="w-[15px] h-[39.5em] bg-gradient-to-b from-opacity-1 to-opacity-0 bg-[#6e5b36]"
                    style={{ background: "linear-gradient(to bottom, rgba(255, 0, 0, 1), rgba(255, 0, 0, 0))" }}
                />
            }
        </div>
