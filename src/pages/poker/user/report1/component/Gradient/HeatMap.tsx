                                        ...
                                        userInfoResult !== undefined &&
                                            ...
                                            playCardArray.map((item, index) =>
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <div className={clsx(isGrid ? "absolute flex justify-center items-center w-full h-[38px] top-0 left-0 border border-gray-600 border-[1px]" : "")}>
                                                        <p className={clsx(isGrid ? "" : "hidden")}>{item}</p>
                                                    </div>
                                                </div>
                                            )
                                            :
